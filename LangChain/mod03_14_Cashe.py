...
messages = [
    {'role': 'system', 'content': ' Vocé é uma expert linkedin e tem um conhecimento profundo sobre o assunto.'},
    {'role': 'user', 'content': 'Me de um texto para postar meu divulgar que estou criando esse bot IA no meu projeto de estudo de IA com LangChain,'
